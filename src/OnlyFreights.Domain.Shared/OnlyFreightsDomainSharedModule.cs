...
public class OnlyFreightsDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        OnlyFreightsGlobalFeatureConfigurator.Configure();
        OnlyFreightsModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<OnlyFreightsDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<OnlyFreightsResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/OnlyFreights");

            options.DefaultResourceType = typeof(OnlyFreightsResource);
        ...
        {
            options.MapCodeNamespace("OnlyFreights", typeof(OnlyFreightsResource));
        });
    }
}
