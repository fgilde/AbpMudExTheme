...
public class OnlyFreightsDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public OnlyFreightsDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
